...
def main():
    ...
    ax_heat.set_title("Variable importance per year — Integrated Gradients",
    ...
    ax_line.legend(fontsize=TICKSIZE - 1, framealpha=0.9, ncol=1,
                   loc="upper left", title="— significant  -- not significant (p>0.05)",
                   title_fontsize=TICKSIZE - 3)
    ax_line.set_title("Linear trend in variable importance (1985–2024)",
                      fontsize=TITLESIZE, fontweight="bold")
