...
BASE = Path("/p/project1/hai_1127/radin1/exprecursors/split_blockyear")
...
def main():
    ...
    parser.add_argument("--period", default="2015-2024",
    ...
    subtitles = {"noSST_layers2": "r=0.683", "SST_layers2": "r=0.864", "deepSST_layers2": "r=0.717"}
