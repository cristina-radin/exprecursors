#!/bin/bash
# Item 3 (lead-time sweep), lead=3d, land_fill_mode=nearest (Aug 22
...
#
#   sbatch --account=mmm_gpu --mail-user=cristina.radin@uni-hamburg.de scripts/slurm/submit_lead3_landfill_partition.sh
...
#SBATCH --job-name=lead3_landfill
#SBATCH --array=0-4
...
CFG="${REPO_DIR}/configs/partition/lead3_landfill/fold${SLURM_ARRAY_TASK_ID}.yaml"

echo "lead3_landfill Fold: ${SLURM_ARRAY_TASK_ID}  Config: ${CFG}"
echo "Start: $(date)"
