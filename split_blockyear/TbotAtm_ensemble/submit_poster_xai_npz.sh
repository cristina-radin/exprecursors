...
#SBATCH --output=/p/project1/hai_1127/radin1/exprecursors/split_blockyear/TbotAtm_ensemble/poster_xai_npz_%j.log
...
# Re-runs IG to regenerate fig_xai_poster.png AND save ig_var_importance.npz
