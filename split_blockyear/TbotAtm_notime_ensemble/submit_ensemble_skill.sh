...
#SBATCH --output=/p/project1/hai_1127/radin1/exprecursors/split_blockyear/TbotAtm_notime_ensemble/ensemble_skill_%j.log
...
python eval/ensemble_skill.py \
    ...
    --output_dir split_blockyear/TbotAtm_notime_ensemble/eval_results \
    --threshold  0.0
